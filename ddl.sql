...
create table tb_course (id bigint generated by default as identity, img_uri varchar(255), name varchar(255), user_id bigint, primary key (id));
create table tb_deliver (id bigint generated by default as identity, correct_count integer, feedback varchar(255), moment TIMESTAMP WITHOUT TIME ZONE, status integer, uri varchar(255), course_id bigint, user_id bigint, lesson_id bigint, primary key (id));
create table tb_enrollment (available boolean not null, enroll_moment TIMESTAMP WITHOUT TIME ZONE, course_id bigint not null, user_id bigint not null, primary key (course_id, user_id));
create table tb_enrollment_lessons_done (enrollment_course_id bigint not null, enrollment_user_id bigint not null, lessons_done_id bigint not null, primary key (enrollment_course_id, enrollment_user_id, lessons_done_id));
...
create table tb_lessons_done (lesson_id bigint not null, user_id bigint not null, course_id bigint not null, primary key (lesson_id, user_id, course_id));
create table tb_notification (id bigint generated by default as identity, moment TIMESTAMP WITHOUT TIME ZONE, read boolean not null, text varchar(255), user_id bigint, primary key (id));
create table tb_reply (id bigint generated by default as identity, body varchar(255), moment TIMESTAMP WITHOUT TIME ZONE, author_id bigint, topic_id bigint, primary key (id));
create table tb_reply_likes (reply_id bigint not null, user_id bigint not null, primary key (reply_id, user_id));
create table tb_resource (id bigint generated by default as identity, description varchar(255), img_uri varchar(255), position integer, title varchar(255), type integer, course_id bigint, primary key (id));
...
create table tb_task (approval_count integer, description varchar(255), due_date TIMESTAMP WITHOUT TIME ZONE, question_count integer, weight integer, id bigint not null, primary key (id));
create table tb_topic (id bigint generated by default as identity, body TEXT, moment TIMESTAMP WITHOUT TIME ZONE, title varchar(255), reply_id bigint, author_id bigint, course_id bigint, lesson_id bigint, primary key (id));
...
INSERT INTO tb_course (name, img_Uri, user_Id) VALUES ('Bootcamp Spring Boot', 'https://cdn.pixabay.com/photo/2018/03/22/10/55/training-course-3250007_1280.jpg', 2);
INSERT INTO tb_course (name, img_Uri, user_Id) VALUES ('Bootcamp Selenium', 'https://cdn.pixabay.com/photo/2018/03/22/10/55/training-course-3250007_1280.jpg', 3);
...
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (1, 'Material de apoio: abc', 'https://www.youtube.com/watch?v=QwQuro7ekvc&t=4096s');
INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 2 do capítulo 1', 2, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (2, '', 'https://www.youtube.com/watch?v=QwQuro7ekvc&t=4096s');
INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 3 do capítulo 1', 3, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (3, '', 'https://www.youtube.com/watch?v=QwQuro7ekvc&t=4096s');
...
INSERT INTO tb_deliver (uri, moment, status, feedback, correct_Count, lesson_id, user_id, course_id) VALUES ('https://github.com/demoraisnight', TIMESTAMP WITH TIME ZONE '2020-12-10T10:00:00Z', 0, null, null, 4, 1, 1);
