...
public class UserUpdateValidator implements ConstraintValidator<UserUpdateValid, UserUpdateInputDTO> {
    ...
    @Override
    public boolean isValid(UserUpdateInputDTO dto, ConstraintValidatorContext context) {
